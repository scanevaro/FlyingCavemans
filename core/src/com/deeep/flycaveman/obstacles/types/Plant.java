 ...
 */
public class Plant extends ObstacleBase {
    public Plant(TextureRegion textureRegion, float spriteSizeX, float spriteSizeY, float sizeX, float sizeY, World world, Body body) {
